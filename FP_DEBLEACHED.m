function [DF_norm, DF_MAD] = FP_DEBLEACHED(DeltaFlour,Window,Fs, ITERATIONS)
...
DF=DeltaFlour;
Parse=round(Window*Fs); % 15000 Miliseconds (15 Seconds) is what we are dividing data into. 
...
%ITERATIONS must be more than 1 to calculate MAD
if ITERATIONS==1
    ITERATIONS=3;
    warning('Iterations was set to too low of a number. Reset iterations to 3');
end
